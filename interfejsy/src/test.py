...
def main():
    try:
        ...
        tutorial.go_to_pose_goal(0.4, 0.4, 0.4)
        tutorial.go_to_pose_goal(0.3, 0.1, 0.2)
        tutorial.go_to_pose_goal(0.5, 0.4, 0.1)
        tutorial.go_to_pose_goal(0.1, 0.2, 0.15)
        tutorial.go_to_pose_goal(0.6, 0.2, 0.4)
